...
export const ALBUMS: Album[] = [
  {
    ...
    duration: 600,
    url: '../../assets/Nouveau dossier (2)/500x500.jpg',
    like: 'Much',
  ...
  },
  {
    ...
    duration: 480,
    url: '../../assets/Nouveau dossier (2)/vano-baby-artiste-de-annee-benin-top-10.jpg',
    like: 'Much',
    status: 'off',
  },
  {
    ...
    duration: 360,
    url: '../../assets/Nouveau dossier (2)/0403860001678769422.jpeg',
  ...
  },
  {
    ...
    duration: 840,
    url: '../../assets/Nouveau dossier (2)/ANG2LIQUE-KIDJO.jpg',
    like: 'Rather',
  ...
  },
  {
    ...
    duration: 840,
    url: '../../assets/Nouveau dossier (2)/burna-boy.jpg',
    like: 'Rather',
    status: 'off',
  },
  {
    ...
    duration: 360,
    url: '../../assets/Nouveau dossier (2)/davido.jpg',
    like: 'Much',
    tags: [
      'consectetur',
      'do',
  ...
  },
  {
    ...
    description:
      'Nostrud veniam dolor velit id occaecat cupidatat aliquip exercitation id aliqua nostrud. Ad mollit Lorem consectetur minim consequat est eiusmod deserunt pariatur est ullamco. Veniam anim veniam Lorem excepteur irure. Esse adipisicing nulla in incididunt. Consectetur fugiat exercitation aliquip excepteur ipsum ullamco ullamco magna commodo.\r\n',
    duration: 240,
    url: '../../assets/Nouveau dossier (2)/fanicko-2-600x600.jpg',
    like: 'Much',
    tags: [
      'consectetur',
      'do',
  ...
  },
  {
    ...
    description:
      'Nostrud veniam dolor velit id occaecat cupidatat aliquip exercitation id aliqua nostrud. Ad mollit Lorem consectetur minim consequat est eiusmod deserunt pariatur est ullamco. Veniam anim veniam Lorem excepteur irure. Esse adipisicing nulla in incididunt. Consectetur fugiat exercitation aliquip excepteur ipsum ullamco ullamco magna commodo.\r\n',
    duration: 240,
    url: '../../assets/Nouveau dossier (2)/gnonnas-pedro.jpg',
    like: 'Much',
    tags: [
      'consectetur',
      'do',
  ...
  },
  {
    ...
    description:
      'Nostrud veniam dolor velit id occaecat cupidatat aliquip exercitation id aliqua nostrud. Ad mollit Lorem consectetur minim consequat est eiusmod deserunt pariatur est ullamco. Veniam anim veniam Lorem excepteur irure. Esse adipisicing nulla in incididunt. Consectetur fugiat exercitation aliquip excepteur ipsum ullamco ullamco magna commodo.\r\n',
    duration: 240,
    url: '../../assets/Nouveau dossier (2)/Tems-2.jpg',
    like: 'Much',
    tags: [
      'consectetur',
      'do',
